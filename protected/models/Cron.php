...
class Cron extends CActiveRecord
{
	...
	public function CronCampFBPost($campaign_id)
	{
		$connection = Yii::app()->db;
		$sql = 'select * from campaign_fbpost where campaign_id="'.$campaign_id.'"';
	...
	public function CronGetFBCampaignPost($campaign_id)
	{
		$connection = Yii::app()->db;
	...
	public function CronCampFSSpecial($campaign_id)
	{
		$connection = Yii::app()->db;
	...
	public function CronFSvenueid($loc_id)
	{
		$connection = Yii::app()->db;
		
		$sql = "SELECT * FROM fsurlinfo where loc_id=".$loc_id;
	...
	public function CronUpdateFBCampaignPost($id,$campaignid)
	{
		$connection = Yii::app()->db;	
		
		$sql = 'update campaign_fbpost set posted_id="'.$id.'", current_status = "running" where campaign_id="'.$campaignid.'"';
	...
	public function CronUpdateFSSpecial($id,$fs_special_id)
	{
		...
		$sql = 'UPDATE fs_special set status="posted",special="'.$id.'",current_status="running" where fs_special_id='.$fs_special_id;
	...
	public function CronRetireFSSpecial($fs_special_id,$status)
	{
		$connection = Yii::app()->db;	
		
		$sql = 'UPDATE fs_special set current_status="'.$status.'" where fs_special_id='.$fs_special_id;
	...
	public function CronRetireFBPost($post_id,$status)
	{
		$connection = Yii::app()->db;	
		
		$sql = 'UPDATE campaign_fbpost set current_status="'.$status.'" where campaign_fbpost_id='.$post_id;
	...
	public function CronGetPendingCampaign($status = '')
	{
		$connection = Yii::app()->db;	
		
		$sql = 'select * from campaign where ';
