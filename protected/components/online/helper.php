...
{
	function getContent($contentId, $langId = 2, $defaultText = '')
	{	
...
if(!function_exists('findpage'))
{
	function findpage($pageid)
	{
		...
		$haystack = array('/user/dashboard'=>'dashboard.introtext','/user/location'=>'venue.introtext','/user/campaign'=>'campaign.introtext','/user/facebook'=>'pages.introtext','/user/buzz'=>'buzz.introtext','/user/profile/view/medias'=>'authentication.introtext');
