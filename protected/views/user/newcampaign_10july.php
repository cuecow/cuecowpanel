...
<form action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/user/newcampaign" method="post" class="styled" enctype="multipart/form-data" onsubmit="return CheckForm(this);" name="campaign">
...
<div class="container container-top">
    ...
    <div class="row-fluid">
		...
		if($_REQUEST['camp'])
			...
			$PendingCamp = Campaign::model()->GetPendingCampaign();
                        ...
                        <div class="accordion-inner">
                            ...
                            <div class="field-content-44">
                            	<div class="field-content-44-left"><label><?php echo getContent('user.newcampaign.timezone',Yii::app()->session['language']); ?>:</label></div>
                                    ...
                                    <option value="<?php echo $key; ?>" <?php if($_POST['timezone'] == $key) echo 'selected'; else if($user_zone[0]['timestamp']==$key) echo 'selected'; ?>><?php echo $value; ?></option>
                                    <?php } ?>
                                	</select> 
                            	</div>
                            </div>
        ...
        <div class="accordion-group" id="twit_div" style="margin-top:15px; display:none;">
            ...
            <div id="collapseSix" class="accordion-body collapse in">
                <div class="accordion-inner">
                	<?php echo getContent('user.newcampaign.sorrytwitter',Yii::app()->session['language']); ?>
                </div>
            </div>
