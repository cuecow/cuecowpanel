...
<div class="container_4" style="padding-top:20px;">
	<div class="grid_4" style="background:#FFF;">
		<div class="panel" style="background:#FFF; border:none;">
			<div class="tab_container form_popup" id="error_addform"></div>
            <div class="tab_container">
                ...
                <tr>
                	<td align="right" style="border:none;">
                    	<a href="#" onclick="ShowHideAddPostForm()"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/close.gif" border="0" /></a>
                    </td>
                </tr>
                <tr>
