    ...
    class Sentiment{
        ...
        public function categorise($sentance)
        {
			...
			if($classification == 'pos') {
			   $result = '<span class="green">Positive</span><br /><img src="images/positive.png"';
			}
			if($classification == 'neg') {
			   $result = '<span class="red">Negative</span><br /><img src="images/negative.png"';
			}
			if($classification == 'neu') {
			   $result = '<span class="grey">Neutral</span><br /><img src="images/neutral.png"';
			}
