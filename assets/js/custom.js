...
$(document).ready(function() {
	...
	try {
		$('.tablesorter')
		.tablesorter({headers: {0:{sorter: false},5:{sorter: false},6:{sorter: false},7:{sorter: false}}, widthFixed: true, widgets: ['zebra']}) 
	...
	$('.fake h2').click(function(){
		$('#acc1 .accordion-content').slideUp('fast');
		$('#acc2 .accordion-content').slideDown('fast');
		$('#acc1').addClass('edit');
	});
	
	$('.fake2 h2').click(function(){
		$('#acc2 .accordion-content').slideUp('fast');
		$('#acc3 .accordion-content').slideDown('fast');
		$('#acc2').addClass('edit');
	});
	
	$('.fake3 h2').click(function(){
		$('#acc3 .accordion-content').slideUp('fast');
		$('#acc4 .accordion-content').slideDown('fast');
		$('#acc3').addClass('edit');
		$('#acc4').addClass('edit');
	});
...
{
	$.post('/index.php/content/savecontents', {'content_id':content_id, 'row':row, 'txt':txt, 'lang':lang}, function(data)
	{
		$('#contenttext_'+row).html(data);
	});
}
