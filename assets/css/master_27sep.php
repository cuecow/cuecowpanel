...
#main-navigation ul { padding:10px 0 0 60px; }
#main-navigation li { display:inline-block; padding:0 1px 0 0; }
#main-navigation li a { position:relative; color:#111; text-decoration:none; font-size:13px; padding-top:12px; padding-bottom:6px; display:block; 
	margin-left:auto;
margin-right:auto;}
/*
