...
#logo { margin:0 0 0 2%; }
#logo h1 { width:100%; margin:0; background-size: 155px 62px; background: url(../images/logo_x2.png) no-repeat 20px center; }
...
#eyebrow-navigation { text-align:right; background:#<?php echo $color; ?>; color:#fff; position:absolute; top:0; left:0; width:88%; padding:5px 6%; height:20px; }
...
<?php } else if ($orientation == 'landscape'){ ?>
#search { position:absolute; width:160px; top:45px; right:6%; }
#search input.go { top:2px; right:2px; }
#subpages .subpage-wrap { margin:0; }
#subpages ul { margin:0 6%; }
<?php } ?>
...
<?php if ($orientation == 'portrait'){ ?>
.button { margin:0 0 10px; width:100% !important; }
.button.small { padding:2% 0; text-align:center; }
.button.medium { padding:3% 0; text-align:center; }
.button.large { padding:6% 0; text-align:center; }
<?php } else if ($orientation == 'landscape'){ ?>
.button { font-size:11px; margin:0 10px 10px 0; }
<?php } ?>
