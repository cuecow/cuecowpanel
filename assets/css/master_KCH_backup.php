...
#main-navigation ul { padding:10px 0 0 200px; }
#main-navigation li { display:inline-block; padding:0 15px 0 0; }
#main-navigation li a { position:relative; color:#fff; text-decoration:none; font-size:13px; padding-top:28px; display:block; }
