...
<?php if (isset($_GET['login']) && $_GET['login']){ ?>
	...
	#login-form { margin:0 auto; width:375px; padding:20px; background:#fff; -moz-border-radius:5px; -webkit-border-radius:5px; border-radius:5px; -moz-box-shadow:1px 1px 3px rgba(0,0,0,0.4); -webkit-box-shadow:1px 1px 3px rgba(0,0,0,0.4); box-shadow:1px 1px 3px rgba(0,0,0,0.4); }
...
<?php } else { ?>
	...
	#logo h1 { margin:0; text-indent:-9999px; height:62px; background: url(../images/logo.png) no-repeat left center; }
